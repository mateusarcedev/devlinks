...
export const metadata = {
  openGraph: {
    title: 'DevLinks',
    description: 'Descubra ferramentas essenciais para programadores. Acelere seu desenvolvimento de software.',
  ...
  return (
    <html lang="pt-br" className='h-full'>
      <Head>
        ...
        <meta property="og:description" content="Descubra ferramentas essenciais para programadores. Acelere seu desenvolvimento de software." />
